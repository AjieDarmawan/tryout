<div class="container pt-5">
        ...
        <div class="row">
            <div class="col-md-12">
            <a class="btn btn-primary mb-2" href="<?= base_url('master/jabatan/tambah'); ?>">Tambah</a>
                <div mb-2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="tablejabatan">
                                <thead>
    ...
    <script>
        ...
        $('#tablejabatan').DataTable({
            ...
            "ajax": {
                ...
                "url": '<?php echo base_url('master/jabatan/ajax_list')?>',
                "type": "POST"
            }
        });
    </script>
      ...
      $(document).on("click",".hapus_dokumen",function(){
            ...
            //  alert(id);
              swal({
                  ...
                  $.ajax({
                      type : "POST",
                      url  : "<?php echo base_url();?>master/jabatan/hapus",
                      dataType: "JSON",
                      data : "id="+id,
