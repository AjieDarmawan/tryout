                    ...
                    <form action="<?php echo base_url('master/Webinar/update_simpan') ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <textarea class="form-control"  name="topik" type="text" id="topik" rows="14" cols="50"><?php echo $webinar->topik;?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" value="<?php echo $webinar->tanggal;?>" name="tanggal" type="date" id="tanggal" rows="14" cols="50" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" rows="4" name="pembicara" type="text" id="pembicara"><?php echo $webinar->pembicara;?></textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" rows="4" name="jabatan_pembicara" type="text" id="jabatan_pembicara"><?php echo $webinar->jabatan_pembicara;?></textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" name="moderator" type="text" id="moderator"><?php echo $webinar->moderator;?></textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" name="jabatan_moderator" type="text" id="jabatan_moderator"><?php echo $webinar->jabatan_moderator;?></textarea>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" rows="14" cols="50" name="desc" type="text" id="desc"><?php echo $webinar->desc;?></textarea>
                                </div>
