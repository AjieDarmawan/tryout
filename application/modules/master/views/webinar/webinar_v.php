...
<div class="container pt-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ">
                <li class="breadcrumb-item"><a>Webinar</a></li>
                <li class="breadcrumb-item active" aria-current="page">List Data</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary mb-2" href="<?= base_url('master/Webinar/tambah'); ?>">Tambah</a>
                <div mb-2>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="tabledivisi">
                                <thead>
                                    <tr class="table-success">
                                        ...
                                        <th>Judul</th>
                                        <th>Pembicara</th>
                                        <th>Jabatan Pembicara</th>
                                        <th>Moderator</th>
                                        <th>Jabatan Moderator</th>
                                        <th>Tanggal</th>
    ...
    <script>
        ...
        $('#tabledivisi').DataTable({
            ...
            "ajax": {
                ...
                "url": '<?php echo base_url('master/Webinar/ajax_list')?>',
                "type": "POST"
            }
        });
    </script>
      ...
      $(document).on("click",".hapus_dokumen",function(){
            ...
            //  alert(id);
              swal({
                  ...
                  $.ajax({
                      type : "POST",
                      url  : "<?php echo base_url();?>master/Webinar/hapus",
                      dataType: "JSON",
                      data : "id="+id,
